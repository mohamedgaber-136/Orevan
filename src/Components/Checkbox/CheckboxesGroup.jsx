  ...
  return (
    <Box sx={{ display: "flex" }}>
      <FormControl sx={{ m: 3 }} component="fieldset" variant="standard">
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={singlState.Name} name={`Name`} />}
            label={`Name`}
          />
          <FormControlLabel
            control={<Checkbox checked={singlState.Email} name={`Email`} />}
            label={`Email`}
          />
          <FormControlLabel
            control={
              <Checkbox
                checked={singlState.MedicalLicense}
                name={`MedicalLicense`}
              />
            }
          ...
          />
          <FormControlLabel
            control={<Checkbox checked={singlState.City} name={`City`} />}
            label={`City`}
          />
          <FormControlLabel
            control={
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={singlState.Organization}
                name={`Organization`}
              />
            }
            label={`Organization`}
